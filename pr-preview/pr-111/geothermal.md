...
*	<p style="text-align: justify;"> Heat source for closed vertical systems: undisturbed ground temperature, assumed to remain constant throughout the year [4]
*	<p style="text-align: justify;"> Heat source for closed horizontal systems: monthly average ground temperatures at a depth of 3 m
* <p style="text-align: justify;"> Heat source for open systems: measured aquifer temperatures [5]
...
<p style="text-align: justify;"> The layer structure of geothermal technologies used for map representation has been completely redesigned. This structure reflects both the diversity and the complexity of geothermal supply options.
...
<p style="text-align: justify;"> Indicative zones include areas with:
	
*	Confined and artesian groundwater bodies
*	Karstifiable rock formations
*	Evaporites
*	Combustible gases

<p style="text-align: justify;"> The corresponding map layers have been newly updated. In these areas, certain geothermal technologies—such as borehole heat exchangers—may be restricted or prohibited by local water authorities, requiring the use of alternative system types or other renewable heat sources. The permitability of geothermal installations in indicative zones must be clarified with local water authorities.
	
The methodology for evaluating ambient heat was already described extensively in Chapter 0. For assessing shallow geothermal resources, additional layers were revised and integrated, including:
