...
The products for the 2025/2026 winter season have been generated by the SnowMaps processing chain, built on the GEOtop physical model, which combines reanalysis weather data, local weather-station and snow-gauge measurements, and snow-cover information derived from Sentinel-2 satellite, following the approach of Dall’Amico et al. (2025).
